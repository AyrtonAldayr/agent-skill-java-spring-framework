...
- **Skill:** spring-security-7.md: new section 7 "Integration with Keycloak" (issuer-uri per realm, optional audience for Resource Server). SKILL.md and README: Keycloak/OIDC issuer in reference tables.

[1.7.1]: https://github.com/AyrtonAldayr/agent-skill-java-spring-framework/compare/v1.7.0...v1.7.1
