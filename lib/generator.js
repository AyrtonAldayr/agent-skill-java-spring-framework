...
${chalk.bold('Install the AI coding skill:')}
  ...
  ${chalk.cyan(`claude skills install github:<your-username>/agent-skill-java-spring-framework`)}

${chalk.dim('Docs: https://github.com/<your-username>/agent-skill-java-spring-framework')}
`);
}
